...
const questions: string[] = [
    'What does the x-axis of the histogram represent? What does the y-axis\
        represent?',
    'Select any two Beats Per Minute (BPM) values on the x-axis. How many data\
        points have BPM values within that range?',
    'The mean is the average value of a distribution of data points, and the\
        ...
        relation to the mean. Estimate the mean and standard deviation of your\
        sample.',
    'A new histogram is produced after every 100 data points. Draw additional\
        data points to get you to 100 and take a screenshot of your histogram.\
        Then draw another 100 data points, and paste a screenshot of the new\
        histogram below. Is it identical to the first one? Why or why not?',
    'Comparing the two histograms from question 4, do you have any way of\
        knowing which one best represents the distribution of all BPMs in your\
